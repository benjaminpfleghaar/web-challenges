	...
	return (
		<div className="app">
			...
			<main className="app__main">
				...
				<EntriesSection allEntriesCount={entries.length} favoriteEntriesCount={favoriteEntries.length} filter={filter} entries={filter === "all" ? entries : favoriteEntries} onToggleFavorite={handleToggleFavorite} onShowAllEntries={handleShowAllEntries} onShowFavoriteEntries={handleShowFavoriteEntries} />
			</main>
			<Footer />
		</div>
	);
