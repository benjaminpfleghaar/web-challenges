...
function App() {
	...
	const [entries, setEntries] = useLocalStorage("entries", { defaultValue: initialEntries });
	const [filter, setFilter] = useLocalStorage("filter", { defaultValue: "all" });
	...
	return (
		<div className="app">
			...
			<main className="app__main">
				...
				<EntriesSection entries={filter === "favorites" ? favoriteEntries : entries} filter={filter} allEntriesCount={entries.length} favoriteEntriesCount={favoriteEntries.length} onToggleFavorite={handleToggleFavorite} onShowAllEntries={handleShowAllEntries} onShowFavoriteEntries={handleShowFavoriteEntries} />
			</main>
			<Footer />
		</div>
	);
