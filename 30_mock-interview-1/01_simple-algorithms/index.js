...
const words2 = ["eclipse", "harmony", "cascade", "labyrinth", "quartz", "serendipity", "zenith", "ephemeral", "vortex", "mystique"];

function averageWordLength(words2) {
	// TODO:

	return words2.map((word) => word.length).reduce((a, b) => a + b) / words2.length;
}

// Unique arrays - return an array without duplicates

const words3 = ["crab", "poison", "contagious", "simple", "bring", "sharp", "playground", "poison", "communion", "simple", "bring"];
